...
const[arman,setArman]=useState(false)   
...
const setpass=(e)=>{
    ...
    const handleShowPopUp = () => {
      ...
      setFlage(true);
      setArman(true)
      // Hide the pop-up after 3 seconds (adjust timing as needed)
      setTimeout(() => {
        setShowPopUp(false);
        // setArman(!arman)
        setFlage(true);
            ...
            try { 
                await axios.post("http://localhost:3300/loginuserDetail",{pass,eeem})
                    .then(res => {
                        ...
                        setEml(res.data.email);
                        setPh(res.data.phone);
  ...
  return (
      ...
      <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            </section>):showUser?(<div className="bg-white overflow-hidden shadow rounded-lg border">
    <div className="px-4 py-5 sm:px-6">
        <h3 className="text-lg leading-6 font-medium text-gray-900">
            User Profile
        </h3>
        <p className="mt-1 max-w-2xl  text-gray-500 text-2xl">
            Welcome to  <span className='text-red-600 text-2xl'>{fName}</span>
        </p>
    </div>
